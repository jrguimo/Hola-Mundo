...
TRAIN_BUTTON.addEventListener('click', trainAndSave);
...
async function loadMobileNetFeatureModel() {
  ...
  mobilenet.summary(null,null,JLPrint);
  ...
  console.log('Se crea una nueva capa para estrenar');
  model.summary();
...
/**
 * Handle Data Gather = Recolectar for button mouseup/mousedown.
 **/
...
async function trainAndSave() {
  ...
  //Una vez estrenada la nueva capa fusionamos los modelos.
...
//Cargamos el modelo para la caracteristicas
